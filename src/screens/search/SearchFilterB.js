      ...
      <SafeAreaView style={styles.screenContainer}>
        ...
        <ScrollView>
          ...
          <View style={styles.row}>
            <View style={[styles.inputContainer, styles.small]}>
              <TextInput
                ...
                placeholder="From 1$"
                value={fromPrice}
                style={[styles.textInput, fromPriceFocused && styles.textInputFocused]}
              />
            </View>
            ...
            <View style={[styles.inputContainer, styles.small]}>
              <TextInput
                ...
                placeholder="To 200$"
                value={toPrice}
                style={[styles.textInput, toPriceFocused && styles.textInputFocused]}
              />
            </View>
          </View>
          ...
          <View style={styles.rowWrap}>
            {
              menu.map((item, index) => (
                this.renderFilterItem({ item, index }, filterArr = menu)
              ))
            }
          </View>
        ...
        <View style={styles.buttonContainer}>
          <Button
            onPress={this.goBack}
            title={"Apply filters".toUpperCase()}
            rounded
          />
        </View>
      </SafeAreaView>
